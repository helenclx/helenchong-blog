---
title: So Long, 42 the School, and Thanks for All the Fish
desc: My farewell to 42 the computer science school, as my local campus is transitioning to a satellite campus.
...
Despite the unfortunate premature end to my 42 journey, I do not regret having attended 42. Attending 42 had encouraged me learn to use Vim, which led to me [switching to Neovim as my go-to code editor](https://helenchong.dev/blog/posts/2025-04-03-i-use-neovim-btw/), learn more about Linux, which led to me [running my own virtual private server (VPS)](https://helenchong.dev/blog/posts/2025-05-19-my-vps-arc-began/) and [switching to using Linux desktop full-time](https://helenchong.dev/blog/posts/2025-06-27-migrate-linux-full-time/), and refreshed my knowledge and skill in the C programming language. My 42 campus had also hosted the [first WordCamp conference in my city](https://helenchong.dev/blog/posts/2025-05-18-wordcamp-johor-bahru-2025/), which I had the privilege to attend after winning a ticket giveaway hosted by the staff of my 42 campus. I will not trade these invaluable experiences for the world.

Furthermore, I am grateful of the staff of my 42 campus for their hard work in managing and organising the campus. Shout-out to the staff member who accommodate my request to add a screen brightness setting in the campus computers, since [retinitis pigmentosa](/topics/retinitis-pigmentosa/) makes my eyes sensitive to bright lights, including bright screens of digital devices.

Since the name of the school, 42, is [a reference to {{ cite "The Hitchhiker's Guide to the Galaxy" }}](https://42.fr/en/what-is-42/42-program-explained/), it would be fitting for me to bid my farewell to the school with another reference to the series:
