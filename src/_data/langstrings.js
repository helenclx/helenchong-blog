export const en = {
	...
	mainNav: "Blog Navigation",
	footerNav: "Footer",
	siteBadgeAlt:
		"88-by-31 badge: Galaxy Garden's logo, a light yellow minimalist shape of a galaxy resembling the capital G, next to the word Galaxy Garden on a dark purple background.",
	welcome: "Welcome to ",
	...
	plaintxtEmail:
		'(<a href="https://useplaintext.email/">Plain text email</a> encouraged)',
...
export const zh = {
	...
	footerNav: "页脚",
	siteBadgeAlt:
		"88 × 31 网页徽章： 银河花园的徽标——一个浅黄色、样子与大写字母 G 相似的简约的银河形状，旁边是 Galaxy Garden 字样，背景为深紫色。",
	welcome: "欢迎光临",
	webDirectories: "网站目录",
	...
	plaintxtEmail:
		'（鼓励使用<a href="https://useplaintext.email/">纯文本电邮</a>）',
	sourceCode: "源代码",
	socialNav: "社交媒体",
	backToTop: "返回顶端",
};
